...
<php lang="en">
	...
	<link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
        ...
        <meta name="description" content="Official website for Thousand Winters SMP">
        ...
        <div class="jumbotron homepage-opening">
            <div class="container">
                <div class="row text-center">
                    <h1 class="head">Thousand Winters SMP</h1>
                    <br />
                    <center><a class="btn btn-huge btn-info btn-glow" href="https://discord.gg/wyznqs3ByY">Join</a></center>
                </div>
            </div>
        </div>
        <!-- /Big opening -->
